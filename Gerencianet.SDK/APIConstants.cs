...
namespace GerencianetSDK
{
    public class APIConstants
    {
        ...
        public static List<IEndpoint> ENDPOINTS { get; }

        static APIConstants()
        {
            ENDPOINTS = new List<IEndpoint>(); // static to avoid refill

            // filling available endpoints
            foreach (IEndpoint ep in GenerateEndPoints())
                ENDPOINTS.Add(ep);          
        }
        ...
        /// </summary>
        /// <returns></returns>
        private static IEnumerable<IEndpoint> GenerateEndPoints()
        {
            yield return IEndpoint<AuthorizeEndpoint>.Endpoint;
            yield return IEndpoint<CreateChargeEndpoint>.Endpoint;
            yield return IEndpoint<DetailChargeEndpoint>.Endpoint;
            ...
            yield return IEndpoint<GetNotificationEndpoint>.Endpoint;
